...
export default function CertificatesPage() {
  ...
  const sanitizeFilename = (name: string) => name.replace(/[^a-zA-Z0-9]/g, "_").replace(/_+/g, "_") + ".pdf";
  ...
  return (
    ...
    <main className="flex-1 bg-transparent dark:bg-transparent text-gray-900 dark:text-gray-100 p-6 sm:p-12 font-sans w-full overflow-x-hidden">
      {/* Toast Notification */}
      {toast && (
        <div className={`fixed bottom-6 right-6 px-6 py-3 rounded-lg shadow-lg z-50 transition-all ${toast.type === "success" ? "bg-green-600 text-white" : "bg-red-600 text-white"}`}>
          {toast.message}
        </div>
      )}
      ...
      {generating && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 flex flex-col items-center gap-4 shadow-2xl">
            ...
            <p className="text-lg font-bold text-gray-800 dark:text-gray-200">{progress}</p>
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <header className="text-center space-y-3">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg">
            قم برفع قالب الشهادة وشيت الأسماء لتوليد جميع الشهادات بصيغة PDF بضغطة زر
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
              <h2 className="font-bold text-gray-800 dark:text-gray-200 mb-4">1. قالب الشهادة (صورة)</h2>
              <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-xl cursor-pointer bg-transparent dark:bg-transparent hover:bg-gray-100 transition-colors">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-200 font-bold">اضغط لرفع الصورة (PNG/JPG)</p>
                </div>
            ...
            {/* Excel Upload */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
              <h2 className="font-bold text-gray-800 dark:text-gray-200 mb-4">2. شيت الأسماء (Excel)</h2>
              <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-xl cursor-pointer bg-transparent dark:bg-transparent hover:bg-gray-100 transition-colors">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  <svg className="w-8 h-8 text-gray-500 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <p className="text-sm text-gray-700 dark:text-gray-200 font-bold">اضغط لرفع شيت الإكسل</p>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 h-full flex flex-col">
              <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-4 flex items-center justify-between">
                ...
                {templateSrc && <span className="text-xs font-normal bg-blue-50 text-blue-700 px-3 py-1.5 rounded-md border border-blue-100 flex items-center gap-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122" /></svg>اسحب الاسم لتحديد المكان</span>}
              </h3>
              ...
              <div className="flex-1 bg-transparent dark:bg-transparent rounded-xl flex items-center justify-center border-2 border-dashed border-gray-200 dark:border-gray-700 overflow-hidden relative p-2 sm:p-6 min-h-[400px]">
                {templateSrc ? (
                  <div 
                    ...
                    style={{ aspectRatio: imgNaturalSize.width && imgNaturalSize.height ? `${imgNaturalSize.width}/${imgNaturalSize.height}` : 'auto' }}
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={templateSrc} alt="Preview" className="w-full h-full object-contain pointer-events-none" draggable={false} />
                  ...
                  <div className="text-gray-400 text-center max-w-sm">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">قم برفع صورة القالب من القائمة الجانبية لتظهر المعاينة هنا وتتمكن من تحديد مكان الاسم.</p>
                  </div>
                )}
              </div>
            </div>
